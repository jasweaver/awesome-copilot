...
**Quick edit for sandbox settings** *(v1.0.81+)*: Press **Ctrl+E** inside the `/sandbox` dialog to open `settings.json` directly in your editor, making it faster to hand-edit sandbox paths, auth settings, or policy overrides instead of navigating the dialog's individual fields.
