...
> ⚠️ **Prerequisites**: Make sure you've completed **[Chapter 00: Quick Start](/docs/learning-hub/cli-for-beginners/00-quick-start/)** first. You'll need GitHub Copilot CLI installed and authenticated before running the demos below.
